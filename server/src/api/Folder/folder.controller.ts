...
class FolderController {
  ...
  getFolderContents = asyncHandler(async (req, res) => {
    ...
    const folderContents = await folderService.getFolderContents(
      folderId,
      userId,
      includeDeleted
    );
  ...
  moveFolder = asyncHandler(async (req, res) => {
    ...
    const updatedFolder = await folderService.moveFolder(
      folderId,
      moveData,
      userId
    );
  ...
  softDeleteFolder = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json(
        new ApiResponse(200, { folder: deletedFolder }, "Folder moved to trash")
      );
  });
  ...
  emptyTrash = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json(
        new ApiResponse(200, { result }, "Folder trash emptied successfully")
      );
  });
  ...
  hasDeletedAncestor = asyncHandler(async (req, res) => {
    ...
    res
      .status(200)
      .json(
        new ApiResponse(200, { hasDeletedAncestor }, "Ancestor check completed")
      );
  });
  ...
  getPinContents = asyncHandler(async (req, res) => {
    ...
    const pinContents = await folderService.getPinContents(
      userId,
      offset,
      limit
    );
      ...
      new ApiResponse(
        200,
        {
          folderContents: {
            ...
            pathSegments: pinContents.pathSegments || [
              { id: null, name: "Pinned" },
            ],
          },
          pagination: {
  ...
  searchContents = asyncHandler(async (req, res) => {
    ...
    const searchResults = await folderService.searchContents(
      userId,
      searchParams
    );
