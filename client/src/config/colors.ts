export type ColorOption = 
  // Classic colors
  'default' | 'blue' | 'fire' | 'lush' | 'sunshine' | 'violet' | 'tangerine' | 
  // Gen Z colors (vibrant/mixed)
  'minty' | 'coralPop' | 'lavenderDream' | 'rosebud' | 'tealWave' | 'candyFloss' | 'deepSea' |
  // Premium colors
  'blingGold' | 'emeraldCity' | 'midnightIndigo' | 'royalViolet' | 'sunsetGlow' | 'aqua' | 'bubblegum';
