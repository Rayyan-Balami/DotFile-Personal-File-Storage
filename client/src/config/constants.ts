...
export const VITE_APP_COPYRIGHT = `Copyright © ${new Date().getFullYear()} ${VITE_APP_AUTHOR}`;
...
export const VITE_ZIP_NAME_PREFIX =
  import.meta.env.VITE_ZIP_NAME_PREFIX || "rY1b-fol-zip-";
