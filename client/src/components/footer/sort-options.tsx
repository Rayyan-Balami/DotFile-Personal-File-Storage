...
export function SortOptions(props: ComponentProps<typeof Button>) {
  ...
  const setSortDirection = useSortPreferencesStore(
  ...
  const setFolderArrangement = useSortPreferencesStore(
    (state) => state.setFolderArrangement
  );
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="min-w-48">
        ...
        >
          ...
          <DropdownMenuRadioItem value="dateUpdated">
            Date Updated
          </DropdownMenuRadioItem>
        ...
        <DropdownMenuRadioGroup
          ...
          onValueChange={(value) =>
            setFolderArrangement(value as FolderArrangement)
          }
        >
          <DropdownMenuRadioItem
            value="separated"
